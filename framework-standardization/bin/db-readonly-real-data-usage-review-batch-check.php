...
$batchRows = array_slice($preparedRows, 0, 4);
$readonlyInput = array(
    ...
    'rows' => $batchRows,
    'diagnostics' => array(
        'checker_mode' => 'standalone_real_data_usage_review_batch_check',
        'prepared_rows_count' => count($preparedRows),
        'requested_batch_rows_count' => 4,
        'batch_rows_count' => count($batchRows),
