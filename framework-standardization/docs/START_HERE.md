...
Перед использованием Codex обязательно прочитать раздел Экономное использование Codex в RULES.md: 
Codex предназначен только для инженерных задач и не используется для механического создания файлов, вставки готовых текстов или простых команд Git.
