...
Причина: для проверки физической совместимости наружный диаметр насоса должен сравниваться с внутренним проходным диаметром обсадной трубы.

Текущая SQL-логика фильтра сохраняется:

`pump_diameter_mm <= casing_diameter_mm`

Для VINKO и других насосов характеристика диаметра должна означать максимальный наружный диаметр насосного агрегата, а не диаметр двигателя и не номинальный размер серии.

Последнее обновление: 2026-07-24 23:10:22 Europe/Kyiv
